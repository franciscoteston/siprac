...
from core.views import (
    ...
    OsUnidadePrazoEditarView,
    OSPrazoHistoricoView,
    OSEntradaUnidadeCriarView,
    OSEntradaUnidadeEditarView,
    OSEntradaUnidadeSaidaView,
    OSEntradaUnidadeHistoricoView,
    OSUnificarEntradaUnidadeView,
...
urlpatterns = [
    ...
    path(
        'os/<int:pk>/producao/nova/',
        ProducaoNovaAPIView.as_view(),
        name='os_producao_nova',
    ),
    ...
    path(
        'os/<int:pk>/prazo-unidade/',
        OsUnidadePrazoEditarView.as_view(),
        name='os_prazo_unidade',
    ),
    path(
        'os/<int:pk>/prazo-historico/',
        OSPrazoHistoricoView.as_view(),
        name='os_prazo_historico',
    ),
    path(
        'os/<int:pk>/entrada-unidade/',
        OSEntradaUnidadeCriarView.as_view(),
        name='os_entrada_unidade_criar',
    ),
    path(
        'os/<int:pk>/entrada-unidade/<int:historico_id>/editar/',
        OSEntradaUnidadeEditarView.as_view(),
        name='os_entrada_unidade_editar',
    ),
    path(
        'os/<int:pk>/entrada-unidade/<int:historico_id>/saida/',
        OSEntradaUnidadeSaidaView.as_view(),
        name='os_entrada_unidade_saida',
    ),
    path(
        'os/<int:pk>/entrada-unidade-historico/',
        OSEntradaUnidadeHistoricoView.as_view(),
        name='os_entrada_unidade_historico',
    ),
    path(
        'os/<int:pk>/unificar-entrada-unidade/',
        OSUnificarEntradaUnidadeView.as_view(),
        name='os_unificar_entrada_unidade',
    ),
    ...
    path('api/os/<int:pk>/etapa/', OSEtapaAPIView.as_view(), name='api_os_etapa'),
    path(
    ...
    path(
        ...
        OSComentariosAPIView.as_view(),
        name='api_os_comentarios',
    ),
